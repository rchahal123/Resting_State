...
#Script Description: This script invokes the PostProcess_Rest_Raj.bash script per individual depending on timepoint and fmriprep version
...
## Invoke PostProcess_Rest_Raj.bash on each subject in this directory

for subjELSdir  in $timepointdir/sub-*/; do
	subjdate=($(basename $subjELSdir))
 $scriptdir/PostProcess_Rest_Raj.bash $subjdate $timepoint $version &
	waitforjobs
 done
